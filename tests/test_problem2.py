...
def test_modelfile():
    ...
    assert (
        favorite_food in content
    ), f"Expected food '{favorite_food}' not found in Modelfile."
    assert (
        favorite_color in content
    ), f"Expected color '{favorite_color}' not found in Modelfile."
